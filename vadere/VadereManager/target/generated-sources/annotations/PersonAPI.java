...
public class PersonAPI extends TraCIClientApi {
	...
	public TraCIResponse getPosition2D(String elementID) throws IOException {
		TraCIPacket p = TraCIGetCommand.build(TraCICmd.GET_PERSON_VALUE, PersonVar.POS_2D.id, elementID);
	...
	public TraCIResponse setPosition2D(String elementId, VPoint data) throws IOException {
		TraCIPacket p = TraCISetCommand.build(TraCICmd.SET_PERSON_STATE, elementId, PersonVar.POS_2D.id, PersonVar.POS_2D.type, data);
	...
	public TraCIResponse getPosition3D(String elementID) throws IOException {
		TraCIPacket p = TraCIGetCommand.build(TraCICmd.GET_PERSON_VALUE, PersonVar.POS_3D.id, elementID);
	...
	public TraCIResponse getMaximumSpeed(String elementID) throws IOException {
		TraCIPacket p = TraCIGetCommand.build(TraCICmd.GET_PERSON_VALUE, PersonVar.MAX_SPEED.id, elementID);
	...
	public TraCIResponse getPosition2DList() throws IOException {
		TraCIPacket p = TraCIGetCommand.build(TraCICmd.GET_PERSON_VALUE, PersonVar.POS_2D_LIST.id, "-1");
